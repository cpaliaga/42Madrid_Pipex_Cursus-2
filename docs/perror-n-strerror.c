...
/** Cuanddo las funciones execve()) y access() no tienen éxito (0),
 ...
 * La función strerror(int) nos ofrece el texto del errror que se 
 * corresponde con su número "errno".
 * Por otro lado la función perror("") nos permite informar por pantalla 
 * del error.
*/
/**
 * Por otro lado la función "write(2, &i, 1);" permite usar el file descriptor 2 que se corresponde con la salida estandar de errorres - stderr"
*/
int main()
{
	int i;
...
// COMPILADO	gcc -Wall -Werror -Wextra perror-n-strerror.c -o err
// EJECUTABLE	./err
/**
 * ➜  docs git:(main) ✗ gcc -Wall -Werror -Wextra perror-n-strerror.c -o err
➜  docs git:(main) ✗ ./err                                               
0 - Undefined error: 0
